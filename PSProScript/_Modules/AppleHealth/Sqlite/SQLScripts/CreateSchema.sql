...
CREATE INDEX IF NOT EXISTS `IX_Reading_StartDate` ON `Reading`(`StartDate` ASC);

CREATE TABLE IF NOT EXISTS `Correlation` (
    `CorrelationId` INTEGER NOT NULL,
    `DataProviderId` INTEGER NOT NULL,
    `TypeId` INTEGER NOT NULL,
    `CorrelationGUID` GUID NOT NULL,
    `Key` TEXT NOT NULL,
    `CreationDate` DATETIME NOT NULL,
    `StartDate` DATETIME NOT NULL,
    `EndDate` DATETIME NOT NULL,
...
CREATE INDEX IF NOT EXISTS `IX_Correlation_StartDate` ON `Correlation`(`StartDate` ASC);
...
CREATE INDEX IF NOT EXISTS `IX_Workout_StartDate` ON `Workout`(`StartDate` ASC);
...
CREATE TABLE IF NOT EXISTS `WorkoutStatistic` (
    ...
    `TypeId` INTEGER NOT NULL,
    `AggregateId` INTEGER NOT NULL,
    `WorkoutStatisticGUID` GUID NOT NULL,
    `Key` TEXT NOT NULL,
    `StartDate` DATETIME NOT NULL,
    `EndDate` DATETIME NOT NULL,
    `Value` NUMERIC NULL,
...
CREATE INDEX IF NOT EXISTS `IX_WorkoutStatistic_StartDate` ON `WorkoutStatistic`(`StartDate` ASC);
